Feature: Web table user order feature
  ...
  Scenario Template: User should be able to place order and order seen in the table
    Given user is already logged in and on order page
    ...
    Examples: Famous male scientists
      ...
      | Screenable  | 4        | CV Raman        | London st | London | England | 50505   | visa     | 1111222233334444 | 12/24   | LCV Raman       |
